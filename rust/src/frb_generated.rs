...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1486587886;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        131 => wire__crate__api__orders__send_fiat_sent_impl(port, ptr, rust_vec_len, data_len),
        132 => wire__crate__api__messages__send_file_impl(port, ptr, rust_vec_len, data_len),
        133 => wire__crate__api__orders__send_invoice_impl(port, ptr, rust_vec_len, data_len),
        134 => wire__crate__api__messages__send_message_impl(port, ptr, rust_vec_len, data_len),
        135 => wire__crate__api__settings__set_active_mostro_node_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        136 => wire__crate__api__escrow__set_cashu_mint_url_override_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        137 => wire__crate__api__settings__set_default_fiat_code_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        138 => wire__crate__api__settings__set_default_lightning_address_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        139 => wire__crate__api__escrow__set_escrow_mode_override_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        140 => wire__crate__api__settings__set_language_impl(port, ptr, rust_vec_len, data_len),
        141 => {
        ...
        143 => wire__crate__api__settings__set_test_order_expiry_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        144 => wire__crate__api__settings__set_theme_impl(port, ptr, rust_vec_len, data_len),
        145 => wire__crate__api__bond__submit_bond_payout_invoice_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        146 => wire__crate__api__disputes__submit_evidence_impl(port, ptr, rust_vec_len, data_len),
        147 => wire__crate__api__reputation__submit_rating_impl(port, ptr, rust_vec_len, data_len),
        148 => wire__crate__api__orders__subscribe_orders_impl(port, ptr, rust_vec_len, data_len),
        149 => wire__crate__api__orders__take_order_impl(port, ptr, rust_vec_len, data_len),
        150 => {
